...
class InfoProyectoController extends Controller
{
    public function index(Request $request)
    {
        ...
        //dd($data);
        return view('areas.infoproyecto.index', compact('data', 'departamentos', 'proyectos'));
        //dd($data, $departamentos, $proyectos);
        //return view('areas.infoproyecto.index', compact('data'));
    }
