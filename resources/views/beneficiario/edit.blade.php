...
@section('content')
    <div class="custom-container mt-4 p-4 bg-light border rounded shadow-md">
        ...
        @foreach ($listar as $beneficiarios)
            <form method="POST" action="{{ route('beneficiario.update', $beneficiarios->id) }}">
                        ...
                        <div class="col-3 col-md-3 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nombres" name="nombres"
                                    value="{{ $beneficiarios->nombres }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-3 col-md-3 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="apellido_paterno" name="apellido_paterno"
                                    value="{{ $beneficiarios->apellido_paterno }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-3 col-md-3 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="apellido_materno" name="apellido_materno"
                                    value="{{ $beneficiarios->apellido_materno }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-3 col-md-3 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento"
                                    value="{{ $beneficiarios->fecha_nacimiento }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-3 col-md-3 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="cedula_identidad" name="cedula_identidad"
                                    value="{{ $beneficiarios->cedula_identidad }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-3 col-md-3 col-lg-3">
                            <div class="form-group">
                                ...
                                <select class="form-input" id="extension_ci" name="extension_ci"
                                    value="{{ $beneficiarios->extension_ci }}">
                        ...
                        <div class="col-3 col-md-3 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="telefono" name="telefono"
                                    value="{{ $beneficiarios->telefono }}" required>
                            </div>
                        </div>
