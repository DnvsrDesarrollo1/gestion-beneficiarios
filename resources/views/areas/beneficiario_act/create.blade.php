                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="nombres_beneficiario"
                                ...
                                value="{{ old('nombres_beneficiario') }}" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="apellido_pa_benef"
                                ...
                                value="{{ old('apellido_pa_benef') }}" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="cedula_benef"
                                ...
                                value="{{ old('cedula_benef') }}" required>
                            @error('cedula_benef')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="nombres_conyugue"
                                ...
                                value="{{ old('nombres_conyugue') }}" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="apellido_pa_conyugue"
                                ...
                                value="{{ old('apellido_pa_conyugue') }}" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="apellido_ma_conyugue"
                                ...
                                value="{{ old('apellido_ma_conyugue') }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" name="fecha_na_conyugue"
                                ...
                                value="{{ old('fecha_na_conyugue') }}" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="cedula_conyugue"
                                ...
                                value="{{ old('cedula_conyugue') }}" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="sexo_conyugue"
                                ...
                                <option value="M" {{ old('sexo_conyugue') == 'M' ? 'selected' : '' }}>Masculino
                                </option>
                                <option value="F" {{ old('sexo_conyugue') == 'F' ? 'selected' : '' }}>Femenino
                                </option>
                            </select>
                            @error('sexo_conyugue')
                                <div class="invalid-feedback">{{ $message }}</div>
