...
<div>
    ...
    <div class="custom-container mt-2 p-2 bg-light border rounded shadow-md">
            ...
            <div class="col-12 col-md-4 mb-3">
                <div class="form-group">
                    ...
                    <select wire:model.live.debounce.300ms="proyecto" id="proyecto" class="form-select">
                        <option value="">-- Seleccione un Departamento --</option>
                        <option value="CONSTRUCCION DE 72 VIVIENDAS TIPO PROYECTO EL PORVENIR">CONSTRUCCION DE 72 VIVIENDAS TIPO PROYECTO "EL PORVENIR"</option>
                        <option value="URBANIZACION SANTA ISABEL">URBANIZACION SANTA ISABEL</option>
                        <option value="CONSTRUCCION DE 72 VIVIENDAS DE VIVIENDA SOCIAL Y SOLIDARIA DEL SUBPROGRAMA 3">CONSTRUCCION DE 72 VIVIENDAS DE VIVIENDA SOCIAL Y SOLIDARIA DEL SUBPROGRAMA 3</option>
                        <option value="CONTRUCCIÓN DE VIVIENDAS EN SECTORES DISPERSOS">CONTRUCCIÓN DE VIVIENDAS EN SECTORES DISPERSOS</option>
                        ...
                        <option value="CUMPLIMIENTO DE CONTRATO DE LA CONSTRUCCION DE VIVIENDAS SOLIDARIAS DE LA URBANIZACION AMACHUMA">CUMPLIMIENTO DE CONTRATO DE LA CONSTRUCCION DE VIVIENDAS SOLIDARIAS DE LA URBANIZACION AMACHUMA</option>
                        <option value="PROYECTO DE LA CIUDAD DE EL ALTO DE LA URBANIZACION TADEO">PROYECTO DE LA CIUDAD DE EL ALTO DE LA URBANIZACION TADEO</option>
                        <option value="URBANIZACION CHARAPAQUI I">URBANIZACION CHARAPAQUI I</option>
                        <option value="CONSTRUCCION URBANIZACION SAN CARLOS  - 25UH">CONSTRUCCION "URBANIZACION SAN CARLOS" - 25UH</option>
                        <option value="CONSTRUCCION URBANIZACION SAN CARLOS  - 2UH">CONSTRUCCION "URBANIZACION SAN CARLOS" - 2UH</option>
                        <option value="PURA PURA">PURA PURA</option>
                        <option value="CONSTRUCCION DE VIVIENDAS SOLIDARIAS URBANIZACION MERCEDARIO">CONSTRUCCION DE VIVIENDAS SOLIDARIAS URBANIZACION MERCEDARIO</option>
                        ...
                        <option value="CONSTRUCCIÓN DE 90 VIVIENDAS PROYECTO EL SALVADOR CIUDAD DE EL ALTO">CONSTRUCCIÓN DE 90 VIVIENDAS PROYECTO EL SALVADOR CIUDAD DE EL ALTO</option>
                        <option value="URBANIZACIÓN RETAMAS III MARIA CAMA ANCALLE">URBANIZACIÓN RETAMAS III MARIA CAMA ANCALLE</option>
                        ...
                        <option value="URBANIZACIÓN TILATA - SECTOR B - 3UH">URBANIZACIÓN TILATA - SECTOR "B" - 3UH</option>
                        <option value="URBANIZACIÓN TILATA - SECTOR B - 1UH">URBANIZACIÓN TILATA - SECTOR "B" - 1UH</option>
                        <option value="CONSTRUCCIÓN PROYECTO URBANIZACIÓN CRISTAL (625 VIVIENDAS)">CONSTRUCCIÓN PROYECTO URBANIZACIÓN CRISTAL (625 VIVIENDAS)</option>
                        <option value="COMPRA DE VIVIENDAS Y TERRENOS URBANIZACIÓN "VILLA MERCEDES" EL ALTO LA PAZ">COMPRA DE VIVIENDAS Y TERRENOS URBANIZACIÓN "VILLA MERCEDES" EL ALTO LA PAZ</option>
                        <option value="URBANIZACIÓN VILLA MERCEDES - SECTOR E">URBANIZACIÓN VILLA MERCEDES - SECTOR "E"</option>
                        <option value="COMPRA DE VIVIENDA ALTO LIMA TERCERA SECCION">COMPRA DE VIVIENDA "ALTO LIMA TERCERA SECCION"</option>
                        ...
                        <option value="COMPRA DE VIVIENDA URBANIZACION VILLA MERCEDES">COMPRA DE VIVIENDA "URBANIZACION VILLA MERCEDES"</option>
                        ...
                        <option value="COMPRA DE VIVIENDA 23 DE MARZO RIO SECO (FAVIA MAMANI)">COMPRA DE VIVIENDA "23 DE MARZO RIO SECO" (FAVIA MAMANI)</option>
                        <option value="COMPRA DE VIVIENDA URBANIZACIÓN BELLA VISTA ELVIS CRUZ">COMPRA DE VIVIENDA URBANIZACIÓN "BELLA VISTA" ELVIS CRUZ</option>
                        <option value="COMPRA DE VIVIENDA ZONA SANTIAGO DE LACAYA - EDGAR SIÑANI">COMPRA DE VIVIENDA ZONA SANTIAGO DE LACAYA - EDGAR SIÑANI</option>
                        <option value="COMPRA DE VIVIENDA NUEVA JERUSALEM">COMPRA DE VIVIENDA "NUEVA JERUSALEM"</option>
                        <option value="COMPRA DE VIVIENDA URBANIZACIÓN CALUYO NESTOR DIORI MAMANI">COMPRA DE VIVIENDA URBANIZACIÓN "CALUYO" NESTOR DIORI MAMANI</option>
                        <option value="URBANIZACIÓN SAN FELIPE DE SEQUE FERNANDO LLANQUE">URBANIZACIÓN "SAN FELIPE DE SEQUE" FERNANDO LLANQUE</option>
                        <option value="SAN FELIPE DE SEQUE SR. EDGAR FLORES CONDORINA">SAN FELIPE DE SEQUE SR. EDGAR FLORES CONDORINA</option>
                        <option value="COMPRA DE VIVIENDA ALPACOMA BAJO CEFERINO TORREZ">COMPRA DE VIVIENDA "ALPACOMA BAJO" CEFERINO TORREZ</option>
                        ...
                        <option value="URBANIZACIÓN COSMOS 79 VICTOR HUGO TOCORARI">URBANIZACIÓN COSMOS 79 VICTOR HUGO TOCORARI</option>
                        <option value="URBANIZACIÓN SANTIAGO II - MOISES QUIROZ">URBANIZACIÓN SANTIAGO II - MOISES QUIROZ</option>
                        <option value="DANIEL C. QUISPE SULLCANI">DANIEL C. QUISPE SULLCANI</option>
                        <option value="JUANA AZURDUY / RAQUEL ILARI VELASCO">JUANA AZURDUY / RAQUEL ILARI VELASCO</option>
                        <option value="URBANIZACIÓN EN EL VERGEL CONTRUCCION DE 250 VIVIENDAS">URBANIZACIÓN EN EL VERGEL CONTRUCCION DE 250 VIVIENDAS</option>
                        ...
                        <option value="COMPRA DE UNA VIVIENDA ALTO TACAGUA HADAAN AYLLON SEGALES">COMPRA DE UNA VIVIENDA ALTO TACAGUA "HADAAN AYLLON SEGALES"</option>
                        ...
                        <option value="COMPRA DE 1 VIVIENDA URBANIZACIÓN RIO SECO (S2), LA PAZ MURILLO, EL ALTO, RIO SECO.">COMPRA DE 1 VIVIENDA "URBANIZACIÓN RIO SECO" (S2), LA PAZ MURILLO, EL ALTO, RIO SECO.</option>
                        <option value="CONSTRUCCIÓN 31 VIVIENDAS URBANIZACIÓN SEÑOR DE MAYO (PRIMAVERA)">CONSTRUCCIÓN 31 VIVIENDAS URBANIZACIÓN SEÑOR DE MAYO (PRIMAVERA)</option>
                        <option value="COMPRA DE UNA VIVIENDA URBANIZACION COSMOS 79 SP2 LA PAZ MURILLO, EL ALTO, COSMOS 79">COMPRA DE UNA VIVIENDA "URBANIZACION COSMOS 79" SP2 LA PAZ MURILLO, EL ALTO, COSMOS 79</option>
                        <option value="CONSTRUCCIÓN DE 18 VIVIENDAS - SEÑOR DE MAYO I MARQUIVIRI">CONSTRUCCIÓN DE 18 VIVIENDAS - SEÑOR DE MAYO I MARQUIVIRI</option>
                        <option value="COMPRA DE 23 (VEINTITRES) VIVIENDAS, URBANIZACIÓN SEÑOR DE MAYO, EL ALTO, LA PAZ.">COMPRA DE 23 (VEINTITRES) VIVIENDAS, URBANIZACIÓN SEÑOR DE MAYO, EL ALTO, LA PAZ.</option>
                        <option value="COMPRA INDIVIDUAL URBANIZACIÓN GERMAN BUSCH 1-1-2 EL ALTO">COMPRA INDIVIDUAL URBANIZACIÓN GERMAN BUSCH 1-1-2 EL ALTO</option>
                        <option value="CONTRUCCION 179 VIVIENDAS URBANIZACIÓN INTI RAYMI">CONTRUCCION 179 VIVIENDAS "URBANIZACIÓN INTI RAYMI"</option>
                        <option value="COMPRA DE CINCO VIVIENDAS URBANIZACIÓN SEÑOR DE MAYO">COMPRA DE CINCO VIVIENDAS "URBANIZACIÓN SEÑOR DE MAYO"</option>
                        <option value="COMPRA DE 12 VIVIENDAS (S3) URBANIZACIÓN TILATA II MUNICIPIO VIACHA, EL ALTO">COMPRA DE 12 VIVIENDAS (S3) "URBANIZACIÓN TILATA II" MUNICIPIO VIACHA, EL ALTO</option>
                        <option
        ...
        <div class="row g-3 p-3">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input wire:model.live.debounce.300ms="lote" type="text" class="form-control"
                            id="loteInput" placeholder="Buscar por lote" style="width: 100%;">
                    </div>
                </div>
            </div>
            ...
            <div class="col-3 col-md-3 col-lg-3 mb-4">
                <div class="form-group">
                    <label for="unidad_habitacionalInput" class="form-label fw-bold">Ingrese la unidad habitacional</label>
                    <div class="input-group">
